...
class NewsSource(Base):
    ...
    language_primary: Mapped[str | None] = mapped_column(String(12))
    languages_available: Mapped[str | None] = mapped_column(Text)
    country: Mapped[str] = mapped_column(String(80))
    region: Mapped[str | None] = mapped_column(String(80))
    homepage_url: Mapped[str] = mapped_column(String(500))
    outlet_type: Mapped[str | None] = mapped_column(String(40))
    ownership_type: Mapped[str | None] = mapped_column(String(40))
    paywall_level: Mapped[str | None] = mapped_column(String(20))
    editorial_reliability_score: Mapped[int | None] = mapped_column(Integer)
    bias_profile: Mapped[str | None] = mapped_column(String(40))
    rating_confidence: Mapped[str | None] = mapped_column(String(20))
    rating_notes: Mapped[str | None] = mapped_column(Text)
